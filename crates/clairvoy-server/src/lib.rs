...
pub use routes::{
    ...
    handle_duplicates, handle_index, handle_runs, handle_scan, handle_status, handle_status_stream,
    handle_tailwind_js, handle_watch_daemon_toggle, handle_watch_paths_add,
